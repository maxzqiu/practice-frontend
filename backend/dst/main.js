...
app.post("/api", (req, res) => {
    let nums = (0, proxy_1.readItems)("shortlink", "longlink", null);
    ...
    try {
        ...
        (0, proxy_1.insertValuesToDatabase)({
...
app.post("/password", (req, res) => {
    ...
    let salt = ((0, proxy_1.readItemsPasswords)("salt", "username", req.body.username));
    let hashed = (0, bcryptjs_1.hashSync)(req.body.password + salt + pepper, salt);
    let savedPassword = (0, proxy_1.readItemsPasswords)("password", "username", req.body.username);
...
app.get("/:url", (req, res) => {
    ...
    console.log(url);
    let expiration = (0, proxy_1.readItems)("expire", "longlink", url);
    let links = (0, proxy_1.readItems)("longlink", "longlink", null);
    if (url in links) {
...
app.post("/createaccount", (req, res) => {
    ...
    let hashed = (0, bcryptjs_1.hashSync)(req.body.password + salt + pepper, salt);
    try {
        (0, proxy_1.insertValuesToPassword)({
            "name": req.body.name,
